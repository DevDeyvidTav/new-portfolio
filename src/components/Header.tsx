...
export function Header() {
    ...
    return(
        <div  className="bg-[#2c2c2c] z-30 fixed px-20 w-full md:max-full md:w-screen h-20 md:h-14 text-white flex items-center justify-between text-lg shadow-lg shadow-[#2c2c2c] md:max-w-full">
