    ...
    return (
        <div id="#" className="text-white text-3xl lg:text-xl justify-center lg:justify-start items-center  lg:items-start flex w-full md:w-screen lg:flex-row flex-col-reverse md:h-screen md:max-w-full overflow-hidden">
            <div data-aos="fade-right" className="textLeft flex flex-col lg:items-start items-center w-[70%] lg:w-[50%] lg:pl-64 pt-20 lg:pt-36">
                ...
                <a href="https://www.linkedin.com/in/deyvid-tavares-37918b236/" target="_blank"><TiSocialLinkedinCircular className="w-12 hover:w-15 hover:h-15 hover:duration-300 h-12 text-[#70F700]"/></a>
                <a href="https://github.com/DevDeyvidTav" target="_blank"><AiFillGithub className="w-10 hover:w-11 hover:h-11 hover:duration-300 text-[#70F700] h-10"/></a>
                <a href="https://wa.me/5581997210434" target="_blank"><AiOutlineWhatsApp className="w-10 hover:w-11 hover:h-11 hover:duration-300 text-[#70F700] h-10"/></a>
                <a href="https://www.instagram.com/deyvid_tavar/" target="_blank"><AiOutlineInstagram className="w-10 hover:w-11 hover:h-11 hover:duration-300 text-[#70F700] h-10"/></a>
                </div>
