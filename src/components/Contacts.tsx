           ...
           <div className="text-white mt-10 text-4xl mb-10 w-full flex justify-start bg-gradient-to-r from-black to-[#121111] py-2 pl-20 font-bold">
            ...
            <div className="flex w-full">
                <form
                    ...
                    <button className="bg-black text-white text-xl py-2 hover:shadow-2xl hover:bg-[#70F700] hover:shadow-[#70F700] hover:duration-300 px-4 rounded-full">Submit</button>
                </form>
